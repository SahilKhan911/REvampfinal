...
export const COHORTS: Record<string, CohortConfig> = {
  ...
  cybersec: {
    ...
    workshopDetails: {
      "ethical-hacking": {
        name: "ETHICAL HACKING",
        tagline: "From script kiddie to ethical hacker — learn to break things the right way",
        originalPrice: 1999,
        eventPrice: 999,
        isDiscounted: true,
        duration: "4 Weeks",
        ...
        curriculum: [
          { week: "Week 1", title: "Recon & Setup", topics: ["Setting up Kali Linux & virtual labs", "Network fundamentals for hackers", "Information gathering & OSINT", "Port scanning with Nmap"] },
          { week: "Week 2", title: "Network Attacks", topics: ["ARP spoofing & MITM attacks", "Password cracking techniques", "Wireless network security", "Metasploit fundamentals"] },
          { week: "Week 3", title: "Web App Security", topics: ["OWASP Top 10 vulnerabilities", "SQL injection & XSS attacks", "Burp Suite for web pentesting", "Authentication bypass techniques"] },
          { week: "Week 4", title: "Advanced & Reporting", topics: ["Privilege escalation techniques", "Post-exploitation strategies", "Writing professional pentest reports", "Bug bounty platforms & methodology"] },
        ],
        outcomes: [
          "Kali Linux & pentesting toolkit mastery",
